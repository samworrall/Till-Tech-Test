describe("Till", () => {
  ...
  describe("#return_receipt", () => {
    it("Calls print_receipt on printer", () => {
      till.return_receipt('Sam', 5.00);
      expect(printer.print_receipt).toHaveBeenCalledWith(till.shop, till.basket, 'Sam', 5.00)
    });

    it("Returns a pretty printed receipt", () => {
      till.process_order('Tea', 1);
      expect(till.return_receipt('Sam', 5.00)).toEqual("The Coffee Connection\n123 Lakeside Way\nPhone: 16503600708\nSam\nTea 1 X 3.65\nTax: $0.32\nTotal: $3.97\nCash: $5\nChange: $1.03")
    });
